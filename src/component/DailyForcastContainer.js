...
function DailyForcastContainer(props) {
    ...
    return <div className={'rounded-lg border-double border-4 border-sky-500 w-[150px] md:w-[180px] '
                + (props.isSelected === props.time ? 'bg-sky-500 border-b-0' : false)}
            ...
            <div className="flex justify-center my-4">
                ...
                <div className="truncate font-semibold text-gray-600 text-[26px] self-end">
